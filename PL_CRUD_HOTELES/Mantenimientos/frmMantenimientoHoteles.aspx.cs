    ...
    public partial class frmMantenimientoHoteles : System.Web.UI.Page
    {
                ...
                if (obj_Hoteles_DAL.iCodigo_Hotel != 0)
                {
                    ...
                    if (obj_Hoteles_DAL.dtDatos.Rows.Count != 0)
                    {
                        _mensaje = obj_Hoteles_DAL.dtDatos.Rows[0][0].ToString() + "<SPLITER>" +
                                    ...
                                    obj_Hoteles_DAL.dtDatos.Rows[0][8].ToString() + "<SPLITER>" +
        ...
        public static string MantenimientoHotel(List<string> obj_Parametros_JS)
        {
            try
            {
                ...
                obj_Hoteles_DAL.iArea_Construccion = Convert.ToInt32(obj_Parametros_JS[10].ToString());
                obj_Hoteles_DAL.dtFecha_Construccion = Convert.ToDateTime(obj_Parametros_JS[6].ToString());
                obj_Hoteles_DAL.sEstado = obj_Parametros_JS[9].ToString();
                obj_Hoteles_DAL.iIdUsuarioGlobal = Convert.ToInt32(obj_Parametros_JS[10].ToString());
