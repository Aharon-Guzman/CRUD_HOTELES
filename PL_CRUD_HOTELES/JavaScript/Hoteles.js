...
function obtieneDetalleHotel() {
    //Crear un objeto para almacenar la información del formulario
    var obj_Parametros_JS = new Array();
    obj_Parametros_JS[0] = $.cookie("FABUNI");
            ...
            success: function (msg) {
                ...
                if (res === undefined) {
                    ...
                    if (resultado === "No se encontraron registros") {
                        ...
                        if (resultado != "") {
                            $("#txtDescripcion_Hotel").val(arreglo[1]);
                            $("#txtDireccion_Fisica").val(arreglo[2]);
                            $("#txtTel").val(arreglo[3]);
                            $("#txtEml").val(arreglo[4]);
                            $("#txtPagWeb").val(arreglo[5]);
                            $("#txtArea_Contrus").val(arreglo[6]);
                            $("#txtFecConst").val(formatDate(arreglo[7]));
...
function mantenimientoHotel() {
    ...
    var obj_Parametros_JS = new Array();
    obj_Parametros_JS[0] = $.cookie("FABUNI");
    obj_Parametros_JS[1] = $("#txtDescripcion_Hotel").val()
    obj_Parametros_JS[2] = $("#txtDireccion_Fisica").val();
    obj_Parametros_JS[3] = $("#txtTel").val();
    obj_Parametros_JS[4] = $("#txtEml").val();
    obj_Parametros_JS[5] = $("#txtPagWeb").val();
    obj_Parametros_JS[6] = $("#txtArea_Contrus").val();
    obj_Parametros_JS[7] = $("#txtFecConst").val(formatDate());
