...
namespace DAL_HOTELES.Mantenimientos
{
    public class cls_Hoteles_DAL
    {
        ...
        private string _sDescripcion_Hotel, _sDireccion_Fisica, _sTelefono, _sCorreo, _sPagina_Web, _sEstado;
        private DateTime _dtFecha_Construccion;
        ...
        public DateTime dtFecha_Construccion { get => _dtFecha_Construccion; set => _dtFecha_Construccion = value; }
