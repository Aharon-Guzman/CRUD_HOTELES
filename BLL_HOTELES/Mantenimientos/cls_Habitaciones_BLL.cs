...
namespace BLL_HOTELES.Mantenimientos
{
    ...
    //            //agregar al data table de parametros la lista de parametros que requiere el procedimiento almacenado
    //            //Regla: Orden de valores del Parámetro: Nombre, Código Tipo de Dato, Valor
    //            obj_Habitaciones_DAL.dtParametros.Rows.Add("@Codigo_Habitacion", "1", obj_Habitaciones_DAL.iCodigo_Habitacion);
    ...
    //            obj_Habitaciones_DAL.dtParametros.Rows.Add("@Descripcion_Habitacion", "6", obj_Habitaciones_DAL.sDescripcion_Habitacion);
    //            obj_Habitaciones_DAL.dtParametros.Rows.Add("@Direccion_Fisica", "6", obj_Habitaciones_DAL.sDireccion_Fisica);
    //            obj_Habitaciones_DAL.dtParametros.Rows.Add("@Telefono", "6", obj_Habitaciones_DAL.sTelefono);
    //            obj_Habitaciones_DAL.dtParametros.Rows.Add("@Correo", "6", obj_Habitaciones_DAL.sCorreo);
    //            obj_Habitaciones_DAL.dtParametros.Rows.Add("@Pagina_Web", "6", obj_Habitaciones_DAL.sPagina_Web);
    //            obj_Habitaciones_DAL.dtParametros.Rows.Add("@Area_Construccion", "1", obj_Habitaciones_DAL.iArea_Construccion);
    //            obj_Habitaciones_DAL.dtParametros.Rows.Add("@Fecha_Construccion", "8", obj_Habitaciones_DAL.dFecha_Construccion);
